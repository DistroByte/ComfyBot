...
class Filter extends Command {
  ...
  async run(message, args, data) {
    ...
    if (filtersUpdated[filterToUpdate]) message.success(`${this.client.emotes?.music} - I'm **adding** the filter to the music, please wait. Note: the longer the music is, the longer this will take.`);
    else message.success(`${this.client.emotes?.music} - I'm **disabling** the filter on the music, please wait. Note: the longer the music is playing, the longer this will take.`);
  }
}
