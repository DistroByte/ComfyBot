module.exports = {
  config: {
    ...
    usage: '',
    category: 'music',
    description: 'Loops or repeats the currently playing song',
  ...
  run: async (client, message, args) => {
    ...
    if (args.join(" ").toLowerCase() === 'queue') {
      ...
      if (client.player.getQueue(message).repeatMode) {
        ...
        return message.channel.send(`${client.emotes.success} - Repeat mode **enabled** the current song will be repeated endlessly!`);
      };
    };
  }
}