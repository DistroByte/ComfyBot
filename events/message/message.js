...
=======
    client.logger.log(`${message.author.username} (${message.author.id}) in ${message.guild.name} | Content ${cmd.help.name} ${args.join(" ")}`, 'cmd');
>>>>>>> fce1600ae935d731812bbb4c96db689d3c19bbd5
